...
const Hero = () => {
  return (
    <section
      id="hero"
      className="min-h-screen flex items-center relative overflow-hidden bg-gradient-to-br from-wedding-accent via-white to-wedding-secondary"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            {siteData.hero.image ? (
              ...
              <div className="rounded-lg overflow-hidden shadow-2xl bg-wedding-secondary aspect-[4/5] lg:aspect-square flex items-center justify-center">
