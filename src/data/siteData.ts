...
export const siteData: SiteData = {
  ...
  dressCode: {
    title: "Dress code",
    text: "Dress code nemáme – přijďte prosím v tom, v čem se cítíte dobře a pohodlně. Hlavně ať si spolu celý den užijeme.",
    // Delší verze (alternativa):
    // textLong: "Dress code nemáme – přijďte prosím v tom, v čem se cítíte dobře a pohodlně. Hlavně ať si spolu celý den užijeme a vytvoříme společně krásné vzpomínky. Důležité je, abyste se cítili dobře a mohli si svatbu užít naplno."
  },
  gifts: {
    title: "Dary",
